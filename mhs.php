...
<head>
  ...
  <title>Mahasiswa - DebitCard Canteen Polinema</title>
...
<div class="wrapper">
  ...
  <aside class="main-sidebar">
    ...
    <section class="sidebar">
      ...
      <ul class="sidebar-menu">
        ...
        <li class="active"><a href="mhs.php"><i class="fa fa-dashboard"></i> <span>Beranda</span></a></li>
  ...
  <div class="content-wrapper">
    ...
    <section class="content-header">
      ...
      <ol class="breadcrumb">
        <li><a href="mhs.php"><i class="fa fa-dashboard"></i> Beranda </a></li>
...
<ul class="list-group list-group-unbordered">
        ...
        ?></p>
             ...
             <div class="col-sm-6">
              <center>
              <img class="img-responsive" style="height: 200px;margin-top: 130px" src="images/mhs/<?php echo $data['foto']; ?>" alt="<?php echo $data['foto']; ?>">
              </center>
            </div> 
          </div>
        </div>
