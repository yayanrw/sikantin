...
if (isset($_POST['simpan'])) {
	...
	$editStan = $db->editStan($id_stan, $nama_stan, $password, $nama_pemilik, $foto, $alamat_pemilik, $no_hp_pemilik, $saldo);
	if ($editStan == "Sukses") {
            ...
            <div class="col-sm-6">
              <form class="form-horizontal" action="" method="post" enctype="multipart/form-data">
                <div class="form-group"><br>
                  ...
                  <div class="col-sm-8">
                    <input type="text" class="form-control" name="id_stan" value="<?php echo $data[0] ?>" readonly>
                  </div>
                </div>
                <br>
                <div class="form-group">
                  ...
                  <div class="col-sm-8">
                    <input type="text" class="form-control" name="nama_stan" value="<?php echo $data[1] ?>">
                  </div>
                </div>
                <br>
                <div class="form-group">
                  ...
                  <div class="col-sm-8">
                    <input type="text" class="form-control" name="password" value="<?php echo $data[2] ?>">
                  </div>
                </div>  
                <br>      
                <div class="form-group">
                  ...
                  <div class="col-sm-8">
                    <input type="text" class="form-control" name="nama_pemilik" value="<?php echo $data[3] ?>">
                  </div>
                </div>
                <br>
                <div class="form-group">
                  ...
                  <div class="col-sm-8">
                    <img src="images/stan/<?php echo $data['foto']; ?>" alt="<?php echo $data[4]; ?>" style="max-height: 150px"><br>
				<input type="file" name="foto" value="<?php echo $data[4]; ?>"> 
                  </div>
                </div>
                <br>
                <div class="form-group">
                  ...
                  <div class="col-sm-8">
                    <input type="text" class="form-control" name="alamat_pemilik" value="<?php echo $data[5] ?>">
                  </div>
                </div>
                <br>
               <div class="form-group">
                  ...
                  <div class="col-sm-8">
                    <input type="text" class="form-control" name="no_hp_pemilik" value="<?php echo $data[6] ?>">
                  </div>
                </div>
                <br>
                <div class="form-group">
                  ...
                  <div class="col-sm-8">
                    <input type="text" class="form-control" name="saldo" value="<?php echo $data[7] ?>">
                  </div>
                </div>
                <br>
                <br>
