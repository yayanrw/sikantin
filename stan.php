...
<div class="wrapper">
  ...
  <aside class="main-sidebar">
    ...
    <section class="sidebar">
      ...
      <ul class="sidebar-menu">
        ...
        <li  class="active"><a href="stan.php"><i class="fa fa-dashboard"></i> <span>Beranda</span></a></li>
        <li><a href="stan_trans.php"><i class="fa fa-address-book"></i> <span>Transaksi</span></a></li>
  ...
  <div class="content-wrapper">
    ...
    <section class="content-header">
      ...
      <center>
        <h1>
        Selamat Datang  <?php echo $_SESSION['stan']; ?> di Web Debit Card Canteen Polinema 
      </h1>
      </center>
      <br>
      <br>
