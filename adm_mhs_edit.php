...
$id = $_GET['id_mhs'];
$getId = $db->getId('mahasiswa', 'nim', $id);
...
if (isset($_POST['simpan'])) {
	...
	$path = "images/mhs/".$foto;
	move_uploaded_file($tmp, $path);

	
	$editMhs = $db->editMhs($nim, $password, $nama, $jurusan, $alamat, $no_hp, $saldo, $foto);
	if ($editMhs == "Sukses") {
		header('location: adm_mhs.php');
	}
	else{
		echo "Data gagal disimpan<br>";
		echo "<a href='adm_mhs_tambah.php'>Kembali</a>";
	}
	exit();
}
?>
 ...
 <div class="content-wrapper">
    ...
    <section class="content-header">
      ...
      <ol class="breadcrumb">
        ...
        <li><a href="adm_mhs.php"><i class="fa fa-user"></i> Mahasiswa </a></li>
            ...
            <div class="col-sm-6">
              <form class="form-horizontal" action="" method="post" enctype="multipart/form-data">
                <div class="form-group"><br>
                  ...
                  <div class="col-sm-8">
                    <input type="text" class="form-control" value="<?php echo $data['nim'] ?>" name="nim" placeholder="Nomor Induk Mahasiswa">
                  </div>
                </div>
                <br>
                <div class="form-group">
                  ...
                  <div class="col-sm-8">
                    <input type="text" class="form-control" value="<?php echo $data['password'] ?>" name="password" placeholder="Password">
                  </div>
                </div>
                <br>
                <div class="form-group">
                ...
                <div class="form-group">
                  ...
                  <div class="col-sm-8">
					...
					<option value="ti"
					<?php if ($data['jurusan'] == 'ti') {
						echo "selected";
					} ?>
					>Teknologi Informasi</option>
					<option value="te"
					<?php if ($data['jurusan'] == 'te') {
						echo "selected";
					} ?>
					>Teknik Elektro</option>
					<option value="tm"
					<?php if ($data['jurusan'] == 'tm') {
						echo "selected";
					} ?>
					>Teknik Mesin</option>
					<option value="ts"
					<?php if ($data['jurusan'] == 'ts') {
						echo "selected";
					} ?>
					>Teknik Sipil</option>
					<option value="tk"
					<?php if ($data['jurusan'] == 'tk') {
						echo "selected";
					} ?>
					>Teknik Kimia</option>
					<option value="ak"
					<?php if ($data['jurusan'] == 'ak') {
						echo "selected";
					} ?>
					>Akuntansi</option>
					<option value="ab"
					<?php if ($data['jurusan'] == 'ab') {
						echo "selected";
					} ?>
                ...
                <div class="form-group">
                  ...
                  <div class="col-sm-8">
                    <input type="text" class="form-control" value="<?php echo $data['alamat']; ?>" name="alamat" placeholder="Alamat">
                  </div>
                </div>
                <br>
                <div class="form-group">
                  ...
                  <div class="col-sm-8">
                    <input type="text" class="form-control" value="<?php echo $data['no_hp']; ?>" name="no_hp" placeholder="Nomor Hp">
                  </div>
                </div>
                <br>
                <div class="form-group">
                  ...
                  <div class="col-sm-8">
                    <input type="text" class="form-control" value="<?php echo $data['saldo']; ?>" name="saldo" placeholder="Saldo">
                  </div>
                </div>
                <br>
                <div class="form-group">
                  ...
                  <div class="col-sm-8">
                    <img src="images/mhs/<?php echo $data['foto']; ?>" alt="<?php echo $data['foto']; ?>" style="max-height: 150px"><br>
                ...
                <div class="form-group">
                  <div class="col-sm-5">
                    <input class="btn btn-primary btn-sm pull-right" type="submit" value="Edit" name="simpan">
                  </div>
                  <div class="col-sm-5">
