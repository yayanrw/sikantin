  ...
  <div class="content-wrapper">
    ...
    <section class="content">
      <div class="row">
    	...
    	<h4>
		<form method="post">
			<a href="adm_mhs_tambah.php" class="btn btn-primary btn-sm"><i class="fa fa-user-plus"></i>  Tambah Data</a>
			        <div class="col-sm-3">
	...
	if (isset($_POST['pencarian'])) {
		...
		$arrayData = $db->tampilData('mahasiswa');
	}
	foreach ($arrayData as $data){
		...
		<tr>
			...
			<td><a href="adm_mhs_detail.php?id_mhs=<?php echo $data['nim']; ?>"><?php echo $data['nama']; ?></a></td>
			<td><?php
				if ($data['jurusan'] == 'ti') {
				...
				<td>
					...
					<a href="adm_mhs_edit.php?id_mhs=<?php echo $data['nim']; ?>#update" title="Edit Data" class="btn btn-warning btn-sm"><i class="fa fa-edit"></i></a>
          <a href="delete.php?id_mhs=<?php echo $data['nim']; ?>" title="Hapus Data" class="btn btn-danger btn-sm"><i class="fa fa-trash"></i></a> 
          <a href="adm_mhs_trans.php?id_mhs=<?php echo $data['nim']; ?>" title="Informasi Transaksi" class="btn btn-info btn-sm"><i class="fa fa-eye"></i></a> 
				</td>
			</tr>
			<?php } ?>
		</table>
